<template>
    ...
    <div v-cloak id="interfaceDetail_container_editor">
        <basic-info ref="basicInfo" initType="creator"></basic-info>
        <!--返回码模板-->
        <return-code-list initType="creator"></return-code-list>
        <!-- 请求参数模板 -->
        <params type="REQ" initType="creator"></params>
        <!-- 响应参数模板 -->
        <params type="RES" initType="creator"></params>
    </div>
</template>
    ...
    export default{
        ...
        methods:{
            getEditedInterfaceInfo(){
                return this.$store.getters.creatorInterfaceInfo;
            },
            saveInterfaceChanges:function(){
                var self = this;
...
//        created(){
//            this.$store.commit('open_editor',true);
//        },
//        beforeDestroy(){
